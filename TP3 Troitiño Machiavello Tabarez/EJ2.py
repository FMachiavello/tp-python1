def domino():
    """ Este codigo devuelve todas las 28 fichas del domino.
        Funciona separando la parte superior de la inferior para poder
        mostrar la ficha tradicional (en vez de poner numeros, pone puntos)."""
